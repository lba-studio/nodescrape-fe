...
const NewsSourceScoreDisplay: React.FC<NewsSourceScoreDisplayProps> = (
  props
) => {
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <Tooltip title="Name of the news source" arrow>
          ...
          <TableBody>
            {newsSourceScores.map((newsSourceScore, index) => {
              ...
              return (
                ...
                >
                  <TableCell style={{ color: textColorHex }}>
                    {index + 1}
                  </TableCell>
                  <TableCell style={{ color: textColorHex }}>
                  ...
                  <TableCell style={{ color: textColorHex }}>
                    {newsSourceScore.score.toFixed(4)}
                  </TableCell>
                </TableRow>
              );
            })}
